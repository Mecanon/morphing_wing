function [ eps, eps_t, MVF, H_cur, Phi_fwd, Phi_rev, chck ] = Elastic_Transformation_check_RI_stress( P, TP, sigma, eps_prev, T, T_prev, T0, sigma_prev, Phi_fwd_prev, Phi_rev_prev, E, MVF, eps_t, eps_t_r, MVF_r )
