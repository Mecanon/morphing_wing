...
raw_data = output_reader("filtered_data_172MPa.txt", header = ['Temperature',
                                               "Strain", "Stress"],)
...
bounds = [(30, 120),(30,120),(0,0.2),(0,0.2),(0,0.2),(0,0.2)]
#cost(T_2, T_3, strain_1, strain_2, strain_3, strain_4)
#result = minimize(cost, x0, method = 'BFGS')
result = differential_evolution(cost, bounds, popsize = 100, maxiter =100)
