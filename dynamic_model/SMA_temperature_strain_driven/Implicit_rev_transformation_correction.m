function [ MVF, eps_t, E, MVF_r, eps_t_r, sigma, Phi_rev ] = Implicit_rev_transformation_correction( MVF, eps_t, E,MVF_r,eps_t_r,sigma, eps, T, T_0,...
    Phi_rev,P, TP)
