...
#==============================================================================
        ...
        if l.check_crossing_joint(tol = 0.01):
            ...
            #Spring components
            l.d = (safety_factor*(2*C+1)*abs(l.F)/(0.1125*A*math.pi))**(1./1.855)
            print safety_factor*(2*C+1)*abs(l.F)*1000./(0.1125*A*math.pi), safety_factor*(2*C+1)*abs(l.F)*1000., (0.1125*A*math.pi)
            l.D = C*l.d
            ...
            l.zero_stress_length = (Nt + 1)*l.d
            l.eps = l.F/(l.k*l.zero_stress_length)
            print l.F,  l.k, l.d, G, l.D, Na, Nt, l.zero_stress_length, safety_factor, l.length_r_0
            print 'different eps:', l.eps, 1 - l.zero_stress_length/(l.y_p*l.r_1 - l.x_p*l.r_2)
            l.update()
            print l.eps
